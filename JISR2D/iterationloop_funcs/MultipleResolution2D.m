function [M,F,phi,VF,VB,In_gridX, In_gridY,FgridX, FgridY] = MultipleResolution2D(M,F,phi,parameters)
        ...
        if(multilev>0)
            for j =1:bf_ct
                ...
                if(grad>=(rho*meangrad))
                    [Dmold,Emold,Pmold] =  Refine2Dtrunc1(bbc(1,1),bbc(1,2),bf_lev,Dm,Em,Pmold,knotvectorU,knotvectorV,pU,pV);
