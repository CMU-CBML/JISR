...
while(abs(rs_final-rs_initial)>tol)
    ...
    timestep
    P1f = P1f - timestep*Bvectf; %update set of first control points
    P1b = P1b - timestep*Bvectb;
    ...
    [BIGXf,BIGYf,BIGXb,BIGYb] = computedeformation(Jm,PHI,PHIU,PHIV,Pmf1,Pmb1);
    ...
    [FBXX,BFXX, PHIF,PHIB,PHIUF,PHIVF,PHIUB,PHIVB]  = bidirectionupdate(ac, parameters, Jm, Coeff, Em, knotvectorU, knotvectorV, nobU, nobV, Pmf1,Pmb1,BIGXXfb,BIGYYfb,BIGXXbf,BIGYYbf);
