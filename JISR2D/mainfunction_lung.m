...
load 'phi_lung_source.mat';
load 'phi_lung_target.mat';
...
tic
[M,F,phi,VF,VB,In_gridX, In_gridY,FgridX, FgridY] = MultipleResolution2D_lung(M,F,phi,parameters);
toc

phi2 = phi_lung_target;
phi2 =(phi2-min(phi2(:)))/(max(phi2(:))-min(phi2(:)));
mlabel = ConvertIntensity2D_lung(phi);
flabel = ConvertIntensity2D_lung(phi2);
